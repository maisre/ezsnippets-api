...
export class PagesService {
  ...
  // Build a downloadable static-site zip for a page. Reuses ez-view's renderer
  // (single source of truth) via the shared export helper.
  async exportZip(
    id: string,
    orgId: string,
    ...
    return exportSiteZip({
      renderUrl: `${this.viewUrl}/view/page/${id}`,
      name: page.name || 'page',
      licensingCsv: csv,
    });
  }
